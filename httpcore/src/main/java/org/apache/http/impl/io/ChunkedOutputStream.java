...
public class ChunkedOutputStream extends OutputStream {
    ...
    private final Map<String, TrailerValueSupplier> trailingHeaders;
    ...
    public ChunkedOutputStream(final int bufferSize, final SessionOutputBuffer out) {
        this(bufferSize, out, Collections.<String, TrailerValueSupplier>emptyMap());
    }

    public ChunkedOutputStream(final int bufferSize,
                               final SessionOutputBuffer out,
                               final Map<String, TrailerValueSupplier> trailerHeaders) {
        super();
    ...
    private void writeTrailers() throws IOException {
        ...
        for (Map.Entry<String, TrailerValueSupplier> header : trailingHeaders.entrySet()) {
            this.linebuffer.clear();
