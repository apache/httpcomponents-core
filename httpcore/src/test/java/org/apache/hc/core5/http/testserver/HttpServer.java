...
package org.apache.hc.core5.http.testserver;
...
public class HttpServer {
    ...
    private volatile org.apache.hc.core5.http.impl.bootstrap.HttpServer server;
    ...
    public int getPort() {
        final org.apache.hc.core5.http.impl.bootstrap.HttpServer local = this.server;
        if (local != null) {
