...
abstract class AbstractH2StreamMultiplexer implements Identifiable, HttpConnection {
        ...
        switch (frameType) {
            ...
            case SETTINGS: {
                ...
                if (frame.isFlagSet(FrameFlag.ACK)) {
                    ...
                    if (support != null) {
                        support.updatePeerSettings(remoteConfig.getMaxConcurrentStreams());
                    }
    ...
    void setPoolSessionSupport(final H2PoolSessionSupport poolSessionSupport) {
        ...
        if (poolSessionSupport != null) {
            ...
            if (remoteSettingState == SettingsHandshake.ACKED) {
                poolSessionSupport.updatePeerSettings(remoteConfig.getMaxConcurrentStreams());
            }
