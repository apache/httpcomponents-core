...
public final class H2PoolSessionSupport {
    ...
    private volatile boolean peerSettingsReceived;
    ...
    /**
     * Returns {@code true} once the peer's initial SETTINGS frame has been
     * received and processed.
     */
    public boolean isPeerSettingsReceived() {
        return peerSettingsReceived;
    }
    ...
    /**
     * Publishes the peer's effective {@code MAX_CONCURRENT_STREAMS} value
     * and marks the initial peer SETTINGS as received.
     */
    public void updatePeerSettings(final int maxConcurrentStreams) {
        peerMaxConcurrentStreams.set(maxConcurrentStreams);
