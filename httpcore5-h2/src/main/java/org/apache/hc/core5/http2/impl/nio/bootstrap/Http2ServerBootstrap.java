...
public class Http2ServerBootstrap {
    ...
    private Http2ServerBootstrap() {
        this.handlerList = new ArrayList<>();
        this.filters = new ArrayList<>();
    }

    public static Http2ServerBootstrap bootstrap() {
        return new Http2ServerBootstrap();
    }
     ...
     * @since 5.0
     */
    public final Http2ServerBootstrap setCanonicalHostName(final String canonicalHostName) {
     ...
     */
    public final Http2ServerBootstrap setIOReactorConfig(final IOReactorConfig ioReactorConfig) {
     ...
     */
    public final Http2ServerBootstrap setHttpProcessor(final HttpProcessor httpProcessor) {
     ...
     */
    public final Http2ServerBootstrap setVersionPolicy(final HttpVersionPolicy versionPolicy) {
     ...
     */
    public final Http2ServerBootstrap setHttp2Config(final Http2Config h2Config) {
     ...
     */
    public final Http2ServerBootstrap setHttp1Config(final Http1Config h1Config) {
     ...
     */
    public final Http2ServerBootstrap setCharset(final CharCodingConfig charCodingConfig) {
     ...
     */
    public final Http2ServerBootstrap setTlsStrategy(final TlsStrategy tlsStrategy) {
        this.tlsStrategy = tlsStrategy;
        return this;
    }

    public final Http2ServerBootstrap setHandshakeTimeout(final Timeout handshakeTimeout) {
     ...
     */
    public final Http2ServerBootstrap setIOSessionDecorator(final Decorator<ProtocolIOSession> ioSessionDecorator) {
     ...
     */
    public final Http2ServerBootstrap setIOSessionListener(final IOSessionListener sessionListener) {
     ...
     */
    public final Http2ServerBootstrap setStreamListener(final Http2StreamListener http2StreamListener) {
     ...
     */
    public final Http2ServerBootstrap setStreamListener(final Http1StreamListener http1StreamListener) {
     ...
     * @since 5.0
     */
    public final Http2ServerBootstrap setLookupRegistry(final LookupRegistry<Supplier<AsyncServerExchangeHandler>> lookupRegistry) {
     ...
     */
    public final Http2ServerBootstrap register(final String uriPattern, final Supplier<AsyncServerExchangeHandler> supplier) {
     ...
     * @param supplier the handler supplier.
     */
    public final Http2ServerBootstrap registerVirtual(final String hostname, final String uriPattern, final Supplier<AsyncServerExchangeHandler> supplier) {
     ...
     */
    public final <T> Http2ServerBootstrap register(
     ...
     * @param requestHandler the handler.
     */
    public final <T> Http2ServerBootstrap registerVirtual(
     ...
     */
    public final Http2ServerBootstrap addFilterBefore(final String existing, final String name, final AsyncFilterHandler filterHandler) {
     ...
     */
    public final Http2ServerBootstrap addFilterAfter(final String existing, final String name, final AsyncFilterHandler filterHandler) {
        Args.notBlank(existing, "Existing");
        Args.notBlank(name, "Name");
        Args.notNull(filterHandler, "Filter handler");
     ...
     */
    public final Http2ServerBootstrap replaceFilter(final String existing, final AsyncFilterHandler filterHandler) {
        Args.notBlank(existing, "Existing");
        Args.notNull(filterHandler, "Filter handler");
     ...
     */
    public final Http2ServerBootstrap addFilterFirst(final String name, final AsyncFilterHandler filterHandler) {
     ...
     */
    public final Http2ServerBootstrap addFilterLast(final String name, final AsyncFilterHandler filterHandler) {
        Args.notNull(name, "Name");
        Args.notNull(filterHandler, "Filter handler");
    ...
    public HttpAsyncServer create() {
        ...
        final IOEventHandlerFactory ioEventHandlerFactory = new ServerHttpProtocolNegotiatorFactory(
                ...
                tlsStrategy != null ? tlsStrategy : new Http2ServerTlsStrategy(443, 8443),
                handshakeTimeout);
