...
class TestDefaultAsyncPushConsumerFactory {
    ...
    void testCreateResolvesConsumer() throws Exception {
        final HttpRequestMapper<Supplier<AsyncPushConsumer>> mapper = mockMapper();
    ...
    private static HttpRequestMapper<Supplier<AsyncPushConsumer>> mockMapper() {
        return (HttpRequestMapper<Supplier<AsyncPushConsumer>>) Mockito.mock(HttpRequestMapper.class);
    }
