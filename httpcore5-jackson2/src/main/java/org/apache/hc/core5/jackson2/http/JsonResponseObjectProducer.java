...
final class JsonResponseObjectProducer extends JsonMessageProducer implements AsyncResponseProducer {
    ...
    public JsonResponseObjectProducer(final HttpResponse response, final AsyncEntityProducer entityProducer) {
        super(entityProducer);
        this.response = Args.notNull(response, "Response");
    }

    @Override
    public void sendResponse(final ResponseChannel channel, final HttpContext context) throws HttpException, IOException {
