...
import org.apache.hc.core5.jackson3.JsonNodeAssembler;
...
public class JsonNodeEntityConsumer extends AbstractJsonEntityConsumer<JsonNode> {
    ...
    public JsonNodeEntityConsumer(final TokenStreamFactory jsonFactory) {
        super(jsonFactory);
    }

    @Override
    protected JsonTokenConsumer createJsonTokenConsumer(final Consumer<JsonNode> resultConsumer) {
