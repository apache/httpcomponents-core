...
final class JsonSequenceRequestConsumer<T> extends AbstractJsonMessageConsumer<HttpRequest, T>
        implements AsyncRequestConsumer<T> {

    private final JsonConsumer<HttpRequest> requestValidator;

    public JsonSequenceRequestConsumer(final Supplier<AsyncEntityConsumer<T>> jsonConsumerSupplier,
