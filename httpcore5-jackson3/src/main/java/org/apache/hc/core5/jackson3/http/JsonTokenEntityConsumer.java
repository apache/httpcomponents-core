...
import org.apache.hc.core5.jackson3.JsonTokenEventHandler;
import org.apache.hc.core5.jackson3.JsonTokenEventHandlerAdaptor;
...
public class JsonTokenEntityConsumer extends AbstractJsonEntityConsumer<Void> {
    ...
    public JsonTokenEntityConsumer(final TokenStreamFactory jsonFactory, final JsonTokenEventHandler eventHandler) {
        super(jsonFactory);
        this.jsonTokenConsumer = new JsonTokenEventHandlerAdaptor(Args.notNull(eventHandler, "JSON event handler"));
    }

    public JsonTokenEntityConsumer(final TokenStreamFactory jsonFactory, final JsonTokenConsumer tokenConsumer) {
        super(jsonFactory);
