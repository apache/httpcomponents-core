...
public class JsonTokenBufferAssemblerTest {
    ...
    void testTokenBufferAssembly() throws Exception {
        ...
        final JsonNode jsonNode = objectMapper.readTree(tokenBuffer.asParserOnFirstToken(ObjectReadContext.empty()));
    ...
    void testTokenBufferSequenceAssembly() throws Exception {
        ...
        final JsonNode jsonNode1 = objectMapper.readTree(tokenBuffer1.asParserOnFirstToken(ObjectReadContext.empty()));
        ...
        final JsonNode jsonNode2 = objectMapper.readTree(tokenBuffer2.asParserOnFirstToken(ObjectReadContext.empty()));
        ...
        final JsonNode jsonNode3 = objectMapper.readTree(tokenBuffer3.asParserOnFirstToken(ObjectReadContext.empty()));
