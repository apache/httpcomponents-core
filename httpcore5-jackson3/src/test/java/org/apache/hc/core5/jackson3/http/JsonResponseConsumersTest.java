...
public class JsonResponseConsumersTest {
    ...
    void testResponseJsonTokenContentCorrectlyProcessed() throws Exception {
        final TokenStreamFactory jsonFactory = objectMapper.tokenStreamFactory();
        ...
        Mockito.verify(mockJsonTokenConsumer).accept(
                Mockito.eq(JsonTokenId.ID_PROPERTY_NAME), Mockito.any(JsonParser.class));
        Mockito.verify(mockJsonTokenConsumer).accept(
    ...
    void testAsyncPipelineErrorResponseInvokesErrorCallbackAndSignalsResultCallback() throws Exception {
        ...
        final AsyncClientExchangeHandler exchangeHandler = AsyncJsonClientPipeline.assemble(objectMapper)
                ...
                .asSequence(
                        ...
                        error -> errorRef.set(error != null ? error.asString() : null),
                        requestData -> {
                        })
