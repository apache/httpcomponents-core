 ...
 *
 */
package org.apache.hc.core5.jackson3.http.examples;
...
import org.apache.hc.core5.jackson3.http.RequestData;
...
public class JsonSequenceRequestExample {
    ...
    public static void main(final String... args) throws Exception {
        ...
        final ObjectMapper objectMapper = JsonMapper.builder(factory)
        ...
        requester.execute(
                AsyncJsonClientPipeline.assemble(objectMapper)
                        .request(BasicRequestBuilder.post(uri)
