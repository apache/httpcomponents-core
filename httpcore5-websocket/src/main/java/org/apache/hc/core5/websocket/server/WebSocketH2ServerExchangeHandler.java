...
final class WebSocketH2ServerExchangeHandler implements AsyncServerExchangeHandler {
    ...
    public void handleRequest(
        ...
        final String protocol = request.getFirstHeader(H2PseudoRequestHeaders.PROTOCOL) != null
                ? request.getFirstHeader(H2PseudoRequestHeaders.PROTOCOL).getValue()
                : null;
    ...
    @Override
    public void streamEnd(final List<? extends org.apache.hc.core5.http.Header> trailers) throws HttpException, IOException {
        inbound.offer(END_INBOUND);
    }
