...
class WebSocketServerRequestHandlerTest {
    ...
    void upgradesValidRequest() throws Exception {
        ...
        final Supplier<WebSocketHandler> supplier = () -> new WebSocketHandler() {
            ...
            @Override
            public void onBinary(final WebSocketSession session, final java.nio.ByteBuffer payload) {
            }

            @Override
            public void onPing(final WebSocketSession session, final java.nio.ByteBuffer payload) {
            }

            @Override
            public void onPong(final WebSocketSession session, final java.nio.ByteBuffer payload) {
            }
