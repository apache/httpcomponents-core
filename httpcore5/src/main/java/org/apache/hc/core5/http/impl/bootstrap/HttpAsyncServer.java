...
public class HttpAsyncServer extends AsyncServer {
    ...
    public HttpAsyncServer(
        ...
        super(eventHandlerFactory, ioReactorConfig, ioSessionDecorator, exceptionCallback, sessionListener,
                        ShutdownCommand.GRACEFUL_NORMAL_CALLBACK, threadPoolListener);
    ...
    public HttpAsyncServer(
            ...
            final IOSessionListener sessionListener,
            final IOReactorMetricsListener threadPoolListener) {
        this(eventHandlerFactory, ioReactorConfig, ioSessionDecorator, exceptionCallback, sessionListener, null, threadPoolListener);
    }
