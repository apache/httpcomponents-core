...
public final class Rfc3986Resolver {
    ...
    public static Rfc3986Uri resolve(final Rfc3986Uri base, final Rfc3986Uri ref) {
        ...
        if (ref.getScheme() != null) {
            ...
            return new Rfc3986Uri(ref.toString(), ref.getScheme(), ref.getUserInfo(), ref.getHost(), ref.getPort(), p, ref.getQuery(), ref.getFragment());
        }
        if (ref.getHost() != null) {
            final String p = DotSegments.remove(ref.getPath());
            return new Rfc3986Uri(ref.toString(), base.getScheme(), ref.getUserInfo(), ref.getHost(), ref.getPort(), p, ref.getQuery(), ref.getFragment());
        }
        ...
        return new Rfc3986Uri(base.toString(), base.getScheme(), base.getUserInfo(), base.getHost(), base.getPort(), mergedPath, q, ref.getFragment());
    }
